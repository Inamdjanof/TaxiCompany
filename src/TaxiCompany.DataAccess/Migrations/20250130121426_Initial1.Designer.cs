...
namespace TaxiCompany.DataAccess.Migrations
{
    ...
    [Migration("20250130121426_Initial1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.CarOwner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("DissmissalDate")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.LogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 12, 14, 26, 432, DateTimeKind.Utc).AddTicks(7340),
                            Email = "inomjonov@gmail.com",
                            FirstName = "Akmal",
                            PasswordHash = "12345678",
                            Role = 1,
                            Salt = "818be664-3c10-4c61-a3ef-aa5ea3c57880"
                        });
                });
            ...
            modelBuilder.Entity("TaxiCompany.Core.Entities.Car", b =>
                {
                    b.HasOne("TaxiCompany.Core.Entities.CarOwner", "CarsOwner")
                        .WithMany()
