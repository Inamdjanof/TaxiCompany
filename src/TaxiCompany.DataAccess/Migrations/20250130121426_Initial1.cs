    ...
    public partial class Initial1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Priprity = table.Column<int>(type: "integer", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pnfl = table.Column<string>(type: "character varying(14)", maxLength: 14, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DissmissalDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CleanInterior = table.Column<bool>(type: "boolean", nullable: false),
                    CleanCar = table.Column<bool>(type: "boolean", nullable: false),
                    Politeness = table.Column<bool>(type: "boolean", nullable: false),
                    SmoothDriving = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("bc56836e-0345-4f01-a883-47f39e32e079"), new DateTime(2025, 1, 30, 12, 14, 26, 432, DateTimeKind.Utc).AddTicks(7340), "inomjonov@gmail.com", "Akmal", null, "12345678", null, null, 1, "818be664-3c10-4c61-a3ef-aa5ea3c57880", null });
